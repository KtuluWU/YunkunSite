...
echo "<div class='text_NPE api_link'>";
echo "(couche basse) <a href='../api_test/pages/NPE_basse_page.php?siren_NPE=$siren' target='_blank'>https://apidata.datainfogreffe.fr:8069/notapme/ratio17?siren=<label class='text-rouge'>$siren</label></a>";
echo "</div>";
