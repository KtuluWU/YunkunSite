...
+function ($) {
	...
	var months = ['Janvier','Févirier','Mars','Avril','Mai','Juin','Juillet','Août','Septembre','Octobre','Novembre','Décembre'],
		short_months = ['Jan','Fév','Mar','Avr','Mai','Jun','Jui','Aoû','Sep','Oct','Nov','Déc'],
		...
		DCalendar = function(elem, options) {
			...
			if(options.mode === 'calendar')
				...
				this.tHead = $('<thead><tr><th id="prev">&lsaquo;</th><th colspan="5" id="currM"></th><th id="next">&rsaquo;</th></tr><tr><th>D</th><th>L</th><th>M</th><th>M</th><th>J</th><th>V</th><th>S</th></tr></thead>');
	...
	DCalendar.prototype = {
		...
		create : function(mode){
			...
			if(mode === "days") {
				...
				var sysDate = "Today: " + daysofweek[that.today.getDay()] + ", "+ months[that.today.getMonth()] + " " + that.today.getDate() + ", " + that.today.getFullYear();
				tBody.append('<tr><td colspan="4" id="today"></td></tr>').appendTo(that.calendar);
			}
		}
	}
