...
class BlogController extends Controller
{
    ...
    public function blogsAction(Request $request)
    {
        ...
        $blogs_db = $em->getRepository('App:Blog')->findBy(array(), array('id' => 'desc'));
    ...
    public function blogdetailAction($blog_title, Request $request)
    {
        ...
        $em = $this->getDoctrine()->getManager();
        $blog_db = $em->getRepository('App:Blog')->findByTitle($blog_title);
        $blog_comments_db = $em->getRepository('App:BlogComment')->findByTitle($blog_title);
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $blogs_db = $em->getRepository('App:Blog')->findAll();
